                        ...
                        <div class="row rating-desc">
                            <div class="col-md-12">
                            	  <label class="checkbox-inline">
                                    <input type="checkbox" value="<?php echo $student_value->student_session_id; ?>" class="clschg" name="clschg" <?php echo ($student_value->student_session_id ==$current_class['student_session_id'] && $student_value->class_id ==$current_class['class_id'] && $student_value->section_id ==$current_class['section_id'] ) ? 'checked' :''; ?>><?php echo ($role == 'parent') ? $name . " " . $student_value->class . " (" . $student_value->section . ")" : $student_value->class . " (" . $student_value->section . ")"; ?>
