               ...
               <tr>
                    <td valign="top">
                        <div class="stimg center-block">
                            <img src="<?php echo base_url() . "uploads/staff_images/no_image.png"; ?>" class="img-responsive img-circle block-center" style="border:5px solid <?php echo $idcard->header_color; ?>">
                        </div>
                        ...
                        <tr>
                            <td valign="top">
                                <div class="staround">
                                    <div class="cardleft">
                                        <div class="stimg">
                                            <img src="<?php echo base_url() . "uploads/staff_images/no_image.png"; ?>" class="img-responsive" />
                                        </div>
                                    </div><!--./cardleft-->
                                    <div class="cardright">
                                        <ul class="stlist">
