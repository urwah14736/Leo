...
<td><?php echo ($examgroupDetail->use_exam_roll_no)?$student->exam_roll_no:$student->roll_no;; ?> </td>
    ...
    <?php
                   ...
                   <div class="clearfix">                                                  
                                              ...
                                              <div class="row">
                                             <div class="col-md-12"> 
                                        <button type="submit" class="btn btn-primary btn-sm pull-right" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please Wait.." autocomplete="off"><?php echo $this->lang->line('save') ; ?> </button>
                                                                           </div>              
                                                                       </div>                         
